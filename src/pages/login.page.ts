...
export class LoginPage extends BasePage {
    elements = {
        signupLoginButton: () => this.page.getByRole('link', { name: LoginLocators.SIGNUP_LOGIN_LINK }),
        emailInput: () => this.page.getByRole('textbox', { name: LoginLocators.EMAIL_INPUT }).first(),
        loginPassword: () => this.page.getByRole('textbox', { name: LoginLocators.PASSWORD_INPUT }).first(),
        ...
        signupName: () => this.page.getByRole('textbox', { name: LoginLocators.NAME_INPUT }),
        signupEmail: () => this.page.getByRole('textbox', { name: LoginLocators.EMAIL_INPUT }).nth(1),
        signupPassword: () => this.page.getByRole('textbox', { name: LoginLocators.PASSWORD_INPUT }),
        signupButton: () => this.page.getByRole('button', { name: LoginLocators.SIGNUP_BUTTON }),
        genderMale: () => this.page.getByRole('radio', { name: LoginLocators.GENDER_MALE_RADIO }),
        genderFemale: () => this.page.getByRole('radio', { name: LoginLocators.GENDER_FEMALE_RADIO }),
        dateDay: () => this.page.locator(LoginLocators.DATE_DAY_SELECT),
        dateMonth: () => this.page.locator(LoginLocators.DATE_MONTH_SELECT),
        dateYear: () => this.page.locator(LoginLocators.DATE_YEAR_SELECT),
        firstName: () => this.page.getByRole('textbox', { name: LoginLocators.FIRST_NAME_INPUT }),
        lastName: () => this.page.getByRole('textbox', { name: LoginLocators.LAST_NAME_INPUT }),
        company: () => this.page.getByRole('textbox', { name: LoginLocators.COMPANY_INPUT }).first(),
        address: () => this.page.getByRole('textbox', { name: LoginLocators.ADDRESS_INPUT }).first(),
        country: () => this.page.getByRole('combobox', { name: LoginLocators.COUNTRY_SELECT }),
        state: () => this.page.getByRole('textbox', { name: LoginLocators.STATE_INPUT }),
        city: () => this.page.getByRole('textbox', { name: LoginLocators.CITY_INPUT }),
        zipcode: () => this.page.locator(LoginLocators.ZIPCODE_INPUT),
        mobilePhone: () => this.page.getByRole('textbox', { name: LoginLocators.MOBILE_NUMBER_INPUT }),
        createAccountButton: () => this.page.getByRole('button', { name: LoginLocators.CREATE_ACCOUNT_BUTTON }),
        headerAccountCreated: () => this.page.getByRole('heading', { name: LoginLocators.ACCOUNT_CREATED_HEADER }),
        headerAccountDeleted: () => this.page.getByRole('heading', { name: LoginLocators.ACCOUNT_DELETED_HEADER }),
